...
BASE_STRINGS: Dict[str, str] = {
    ...
    "WorkspaceTagline": "Build polished chromatic scales with guided configuration.",
    "SampleSetup": "Sample setup",
    "SampleSetupDescription": "Choose your sample folder, configure the musical range, and prepare processing.",
    "TimingAndTuning": "Timing & tuning",
    "ProcessingOptions": "Processing options",
    "GenerationStatus": "Generation status",
    "SummaryReady": "Ready: {semitones} semitones from {note}{octave} with {gap:.2f}s gap.",
    "SummaryWaiting": "Select a valid sample folder to enable generation.",
    "&File": "&File",
    "Open Sample Folder…": "Open Sample Folder…",
