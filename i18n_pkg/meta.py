...
BASE_STRINGS: Dict[str, str] = {
    ...
    "SampleSetupIntro": "Point to your numbered samples and configure how the scale should render.",
    ...
    "LogOutput": "Generation log output",
    "LayoutResetMessage": "Layout reset to default arrangement.",
    "SettingsTabLanguage": "Language",
    "SettingsTabPaths": "Paths",
    "SettingsTabAdvanced": "Advanced",
    "LanguageLabel": "Language",
    "AutoReloadTranslations": "Auto-reload translations on text changes",
    "OutputFolder": "Output folder",
    "OutputFolderPlaceholder": "Leave blank to use the sample folder",
    ...
    "StartingNoteHint": "First note used when calculating the chromatic scale.",
    "StartingOctaveHint": "Octave applied to the starting note.",
    "SemitoneRangeHint": "Total semitone steps to include in the generated scale.",
    "GapSecondsHint": "Silence duration inserted between each rendered note in seconds.",
